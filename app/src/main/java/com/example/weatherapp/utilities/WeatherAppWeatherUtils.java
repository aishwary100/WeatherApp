...
import com.example.weatherapp.data.WeatherappPreferences;

public final class WeatherAppWeatherUtils {

    private static final String LOG_TAG = WeatherAppWeatherUtils.class.getSimpleName();
